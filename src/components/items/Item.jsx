...
const Item = ({id, category, product, image}) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center mt-8  w-96 bg-transparent border-solid border-4 border-gray-200 rounded">
            ...
            <div className="flex flex-col w-full justify-center items-center">
                ...
                <Link to={`/Products/${id}`} className="w-full text-white text-shadow-h1 text-center">Details</Link>
            </div>
        </div>
    )
}
